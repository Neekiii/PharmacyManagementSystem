<?php
  ...
  function storeAdminData() {
    ...
    if($con) {
      ...
      $query = "INSERT INTO admin_credentials (USERNAME, PASSWORD, IS_LOGGED_IN, PHARMACY_NAME, ADDRESS, EMAIL, CONTACT_NUMBER ) VALUES('$username', '$password', 'false', '$pharmacy_name', '$address', '$email', '$contact_number')";
      $result = mysqli_query($con, $query);
