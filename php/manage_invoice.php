  ...
  function printInvoice($invoice_number) {
    ...
    <div class="row">
      ...
      <div class="col-md-10 h3" style="color: #ff5252;">Gorkha Gandaki Swasthya clinic<br> Nayabazar-7,Kathmandu<br>
        Tel:01-4385194<span class="float-right">Invoice Number : <?php echo $invoice_number; ?></span></div>
    </div>
